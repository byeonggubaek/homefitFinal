...
INSERT INTO T_NAV_SUB_ITEM VALUES
('NAV00002', 'S0003', '질문과답변','/menu/QandA.jpg', '질문과답변 .', 'HistoryQandA', '/history/qanda');
INSERT INTO T_NAV_SUB_ITEM VALUES
...
-- COL_TYPE 
-- key : font-medium -- 키 
-- qty : text-right / formatNumber -- 수량  
-- prc : text-right / formatPrice -- 단가   
-- amt : text-right / formatCurrency -- 금액  
-- dat : text-center / formatDate -- 일자   
-- tim : text-center / formatTime -- 시간  
-- lst : color rounded px-2 py-1 -- 열거형 
-- chk : -- 선택
-- act : -- 메뉴
-- str : -- 문자 
--------------------------------------------------------------------------------------------------------------------------------
...
(
    ...
    COL_HIDDEN		VARCHAR(1)  NOT NULL DEFAULT 'N' COMMENT '감춤 여부 (Y,N)',
    COL_SORT 		VARCHAR(1)  NOT NULL DEFAULT 'N' COMMENT '정렬 여부 (Y,N)',
    COL_PIN 		VARCHAR(1)  NOT NULL DEFAULT 'N' COMMENT '고정 여부 (L,R,N)',
    COL_SUM    		VARCHAR(100),
...
INSERT INTO T_COLUMN_DESC VALUES ('WorkoutRecord', 5, 5, 'WOO_NAME_COLOR', '', 'str', 0, 'N', 'N', 'N', NULL);
INSERT INTO T_COLUMN_DESC VALUES ('WorkoutRecord', 6, 6, 'WOO_NAME', '운동명', 'lst', 70, 'Y', 'Y', 'N', 'cnt');
INSERT INTO T_COLUMN_DESC VALUES ('WorkoutRecord', 7, 7, 'WOD_TARGET_REPS', '반복횟수/초', 'qty', 90, 'Y', 'N', 'N', 'max');
...
INSERT INTO T_COLUMN_DESC VALUES ('WorkoutRecord', 10, 10, 'WOD_POINT', '획득포인트', 'qty', 90, 'Y', 'N', 'N', 'sum');
...
(MEM_ID_VIEW, MEM_NAME, MEM_NICKNAME, MEM_PASSWORD, MEM_IMG, MEM_PNUMBER, MEM_EMAIL, MEM_SEX, MEM_AGE, MEM_POINT, MEM_EXP_POINT, MEM_LVL,  MEM_STREAK, MES_ID)
VALUES
('moon@naver.com', '문정인', '고양이', member_hash_password('moon@naver.com', '1234'), '/member/U000002.jpg','010-5555-5555','ZZ@NAVER.COM','F', 24, 1050, 2050, 1, 2, 2);
INSERT INTO T_MEMBER 
(MEM_ID_VIEW, MEM_NAME, MEM_NICKNAME, MEM_PASSWORD, MEM_IMG, MEM_PNUMBER, MEM_EMAIL, MEM_SEX, MEM_AGE, MEM_POINT, MEM_EXP_POINT, MEM_LVL,  MEM_STREAK, MES_ID)
VALUES
