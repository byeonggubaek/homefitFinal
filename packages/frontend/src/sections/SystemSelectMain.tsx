...
const formSchema = z.object({
  method: z.enum(["G", "P"], {
    message: "Method는 GET 또는 POST여야 합니다.", 
  }),
  eventHandler: z
    .string()
      ...
      <div className="w-1/2">
        <Card className="w-full">
          <CardHeader>
            ...
            <CardDescription>
              쿼리를 입력하면 Backend Code를 생성해주는 LLM 프럼프트를 만들어 줍니다.
            </CardDescription>
            <CardAction>  
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      ...
                      <Input
                        ...
                        placeholder="이벤트 핸들러를 입력하세요 ex) getMember "
                        autoComplete="off"
                      />
                      {fieldState.invalid && (
